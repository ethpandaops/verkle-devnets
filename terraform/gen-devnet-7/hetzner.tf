...
////////////////////////////////////////////////////////////////////////////////////////
provider "hcloud" {
  token = var.verkle_hcloud_token
}
////////////////////////////////////////////////////////////////////////////////////////
//                                        VARIABLES
////////////////////////////////////////////////////////////////////////////////////////
variable "verkle_hcloud_token" {
  type        = string
...
locals {
  ...
  hcloud_default_server_type = "ccx23"
...
resource "cloudflare_record" "tooling_record_witness" {
  ...
  type    = "A"
  value   = hcloud_server.main["lodestar-geth-witness-1"].ipv4_address
  proxied = false
  ttl     = 120
}
...
resource "cloudflare_record" "tooling_record_witness6" {
  ...
  name    = "witness.${var.ethereum_network}"
  type    = "AAAA"
  value   = hcloud_server.main["lodestar-geth-witness-1"].ipv6_address
  proxied = false
  ttl     = 120
}
...
resource "local_file" "ansible_inventory" {
  ...
  filename = "../../ansible/inventories/gen-devnet-7/inventory.ini"
}
